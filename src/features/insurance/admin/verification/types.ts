/**
 * Backend DTOs for the Admin verification surface (admin-swagger.json).
 * InsuranceVerificationResponseDto / InsuranceEligibilityResponseDto are
 * already typed in the review feature and reused.
 */
